...
#ifndef RECOMMENDATION_SINGLETON_HPP
#define RECOMMENDATION_SINGLETON_HPP
...
void Singleton::Init(const std::string InputFile){
...
#endif //RECOMMENDATION_SINGLETON_HPP
